...
export function RegisterScreen({ onBack, onRegister, onSocialLogin }: RegisterScreenProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-[#f8fafc] ml-4">Create Account</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col justify-center">
        <div className="space-y-6 mb-8">
          ...
          <div className="space-y-2">
            <Label htmlFor="confirmPassword" className="text-[#cbd5e1] font-medium">
              Confirm Password
            </Label>
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#94a3b8]" />
